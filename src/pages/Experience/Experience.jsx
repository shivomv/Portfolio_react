  ...
  const experiences = [
    {
      ...
      period: "2022",
      description:
        "Worked remotely on core PHP projects including backend logic, database handling, and custom web functionalities.",
    },
    {
      icon: Layers,
      ...
      period: "2023 - present",
      description:
        "Working on enterprise systems using PHP (Laravel) for backend and React for frontend. Focus on real-time data dashboards, secure APIs, and dynamic forms.",
    },
  ];
